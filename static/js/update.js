...
update_reservation1.placeholder='Username..', update_reservation1.className += 'form-control text-white shadow-none'; 
update_reservation1.style.borderColor='#625b4b',
update_reservation1.style.backgroundColor='#0c0b09';

update_reservation2.placeholder='Username..', update_reservation2.className += 'form-control text-white shadow-none'; 
update_reservation2.style.borderColor='#625b4b',
update_reservation2.style.backgroundColor='#0c0b09';

update_reservation3.placeholder='Username..', update_reservation3.className += 'form-control text-white shadow-none'; 
